...
Note that **everytime** an `.ai_box` is used throughout the case study, a lua filter will automatically add an AI use disclaimer/margin note to accompany the box during rendering.
