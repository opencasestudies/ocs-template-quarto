...
* Asking a chatbot the same question more than once (even with the same prompt!) can result in different answers, so keep that in mind for reproduciblity considerations

::::
:::
:::

Finally, you may want to provide information about reproduciblity considerations .... this box may be appropriate in several places throughout the case study, but perhaps you'll want a note right before summary. Use something like the following for such cases (though you may want to rename the header within `reproducibility_box_header` depending on your specific use case):
